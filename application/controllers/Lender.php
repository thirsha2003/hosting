			  ...
			  //  $checkToken = $this->check_token();
			   if(True)
			   {
					   ...
					   if(isset($params['id'])){
						  ...
						  $sql = 'SELECT  bd.company_name, bd.turnover, bd.networth, bd.profilecomplete, bd.profilecomplete_percentage , bd.gst, bd.cin, bl.name as location ,t1.name as industry,t2.name as entity
