	...
	public function borrower_leads_fullcomplete()
	{
		...
		if($method =="POST")
		{
			...
			if(True)
			{
				...
				WHERE b.slug ='borrower' AND b.status in ('completed') AND b.id = bd.user_id AND bd.company_name is not null AND bd.profilecomplete = 'completed' AND bd.profilecomplete_percentage =100) 
