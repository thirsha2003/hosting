			 ...
			 if ($this->db->trans_status() === FALSE)
			  ...
			  return json_output(200,array('status' => 200,'message' => 'Try again'));
			   ...
			   try {
				...
				$subject = "Dear " . $rm_email . ",";
				$message = "Dear " .$rm_email . "," . "<br/><br/>" . "A new application for " . $rm_email . " has been assigned to you by the Superadmin.<br/>
					   Please click on the below link to view " . $rm_email . ".<br/><br/>" .
					"link : app.finnup.in/#/admin.";
...
public function  borrowerloanrequest()
 ...
 public function admin_create_loanrequest()
  ...
  public function getcibildetails()
			...
			public function loanapplicationviewlender()
	{
			$method = $_SERVER['REQUEST_METHOD'];
			if($method =="POST")
			{
